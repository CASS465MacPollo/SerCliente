 ...
 * @author Oficina
 */
public class DialogRetomarGestion extends javax.swing.JDialog {
     ...
     */
    public DialogRetomarGestion(java.awt.Frame parent, boolean modal, VentanaAlmacenes vAlmacenes) {
        super(parent, modal);
        initComponents();
        
        this.vPrincipal = (VentanaPrincipalMostrador) parent;
